...
1. 先阅读 `README.md`、`docs/architecture.md`、`docs/roadmap.md`、`docs/a_share_factor_prd_v1.md`、`docs/a_share_factor_dictionary_v1.md`、`docs/a_share_architecture_design_spec_v1.md`
2. 每次只完成一个清晰的子任务
3. 修改前先确认目录与职责边界
